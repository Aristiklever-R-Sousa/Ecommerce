								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <input type="text" value="<?php echo htmlspecialchars( $cart["deszipcode"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="00000-000" id="billing_address_1" name="deszipcode" class="input-text ">
										...
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
											...
											<input type="text" value="<?php echo htmlspecialchars( $address["desaddress"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="Logradouro e número" id="billing_address_1" name="desaddress" class="input-text ">
										</p>
										...
										<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											<label class="" for="billing_state">Estado <abbr title="required" class="required">*</abbr></label>
										...
										<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											<label class="" for="billing_state">País <abbr title="required" class="required">*</abbr></label>
