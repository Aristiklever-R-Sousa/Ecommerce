                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li>
                                <a href="/cart"><i class="fa fa-shopping-cart"></i> Meu Carrinho</a>
                            </li>
                            <?php if( checkLogin(false) ){ ?>
                                <li>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/cart">Carrinho - <span class="cart-amunt">R$<?php echo getCartSubTotal(); ?></span> <i class="fa fa-shopping-cart"></i> <span class="product-count"><?php echo getCartNrQtd(); ?></span></a>
                    </div>
                </div>
            </div>
        </div>
